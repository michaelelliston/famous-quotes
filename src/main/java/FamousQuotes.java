...
public class FamousQuotes {
    public static void main(String[] args) {
        ...
        String[] quotes = {"\"That wizard came from the Moon.\" - Ghost", "\"I am a wall. And walls don't move. Because walls don't care.\" - Saint-14", "\"I don't have time to explain why I don't have time to explain.\" - Elsie Bray"};
